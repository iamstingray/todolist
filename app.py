...
# define endpoint for adding a new item to a list
...
# define endpoint for updating an existing item in a list
...
# define endpoint for deleting an existing item from a list
